...
public class Main {
    public static void main(String[] args){
        ...
        GunSpec liked = new GunSpec("Military", Type.MUSKET, "over 9000", 2);
    ...
    private static void initializeStore(GunStore store){
        store.addGun("q123we", "da21", Type.BLUNDERBUSS, "under 9000", 300, 9000);
        store.addGun("mf8873", "d14d", Type.ARQUEBUS, "under 300", 150, 45000);
        store.addGun("re3123t", "lf32", Type.BLUNDERBUSS, "under 1200", 400, 3000);
        store.addGun("HU1h14", "Military", Type.MUSKET, "over 9000", 2, 3000);
    }
}
